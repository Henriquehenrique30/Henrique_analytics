                ...
                <div className="animate-in fade-in duration-700 space-y-6">
                  ...
                  <div className="grid grid-cols-12 gap-6">
                    ...
                    <div className="col-span-12 lg:col-span-5 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-4">
                      ...
                      <StatCard label="Dribles Totais" value={selectedPerformance.analysis.stats.dribbles || 0} suffix={`Certos: ${selectedPerformance.analysis.stats.dribblesWon || 0}`} icon="👟" color="bg-purple-500/20 text-purple-500" isActive={metricFilter === 'dribbles'} onClick={() => setMetricFilter(metricFilter === 'dribbles' ? null : 'dribbles')} />
                      <StatCard label="Erros Críticos" value={selectedPerformance.analysis.stats.errors || 0} icon="⚠️" color="bg-red-500/20 text-red-500" isActive={metricFilter === 'errors'} onClick={() => setMetricFilter(metricFilter === 'errors' ? null : 'errors')} />
